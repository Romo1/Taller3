  ...
  //  }
     ...
     public String tieneAzucarModificar() {
      ...
      public int tieneAzucarAgregar() {
        if (agregar.getjSi().isSelected() == true&&agregar.getTxtCategoria().getSelectedIndex()==0 ) {
            return 1;
        } else if(modificar.getTxtCategoria().getSelectedIndex()==0&&modificar.getjNo().isSelected() == true){
            return 0;
        }else{
            return 0;
        }
